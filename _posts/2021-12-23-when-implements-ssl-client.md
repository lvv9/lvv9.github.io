...
曾经对密码学有一定的研究，这次本着get your hands dirty的原则，打算造一造轮子——一个简单的SSL客户端。项目代码见 [这里](https://github.com/lvv9/tls) <br>
SSL/TLS最广泛的应用当然是HTTP，所以开始时拿OkHttp的源码研究了一番。不久后发现，OkHttp是比较接近应用层的。打算验证的类似于[4.20 没有 accept，能建立 TCP 连接吗？](https://xiaolincoding.com/network/3_tcp/tcp_no_accpet.html) <br>
翻到这份 [JSSE参考指南](https://docs.oracle.com/javase/7/docs/technotes/guides/security/jsse/JSSERefGuide.html) 。<br>
